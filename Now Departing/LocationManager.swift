...
class LocationManager: NSObject, ObservableObject, CLLocationManagerDelegate {
    ...
    func requestLocationPermission() {
        print("DEBUG LocationManager: Requesting permission")
        locationManager.requestWhenInUseAuthorization()
    }
    
    func startLocationUpdates() {
        print("DEBUG LocationManager: startLocationUpdates called")
        print("DEBUG LocationManager: Current auth status: \(authorizationStatus.rawValue)")
        
        guard authorizationStatus == .authorizedWhenInUse || authorizationStatus == .authorizedAlways else {
            print("DEBUG LocationManager: Not authorized, requesting permission")
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        print("DEBUG LocationManager: didUpdateLocations called with \(locations.count) locations")
        
        guard let newLocation = locations.last else {
            print("DEBUG LocationManager: No location in array")
            return
        }
        
        print("DEBUG LocationManager: New location: \(newLocation.coordinate.latitude), \(newLocation.coordinate.longitude)")
    ...
    func locationManagerDidChangeAuthorization(_ manager: CLLocationManager) {
        print("DEBUG LocationManager: Authorization changed to: \(manager.authorizationStatus.rawValue)")
        authorizationStatus = manager.authorizationStatus
        isLocationEnabled = (authorizationStatus == .authorizedWhenInUse || authorizationStatus == .authorizedAlways)
        
        print("DEBUG LocationManager: isLocationEnabled = \(isLocationEnabled)")
